...
public class Dragon extends Fractal {
    public Dragon(float xPos1, float yPos1, float xPos2, float yPos2, Fractal parent) {
    ...
    void iterate() {
        ...
        new Dragon(xPos1, yPos1, pointX, pointY, this).addToList();
        new Dragon(xPos2, yPos2, pointX, pointY, this).addToList();
    }
}
