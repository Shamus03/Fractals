...
public class GoldenBeetle extends Fractal {
    public GoldenBeetle(float xPos1, float yPos1, float xPos2, float yPos2, int iteration) {
    ...
    void iterate() {
        ...
        new GoldenBeetle(xPos1, yPos1, pointX, pointY, iteration + 1).addToList();
        new GoldenBeetle(xPos2, yPos2, pointX, pointY, iteration + 1).addToList();
